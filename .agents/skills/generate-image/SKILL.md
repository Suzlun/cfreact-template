...
Use `.agents/skills/generate-image/scripts/generate-image.mjs` as the normal
...
```bash
node .agents/skills/generate-image/scripts/generate-image.mjs \
  --template <template> \
...
not establish approval or replace real browser review.
