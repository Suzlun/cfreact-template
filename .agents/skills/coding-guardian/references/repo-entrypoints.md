...
- `openspec/config.yaml`: OpenDesign ownership of `PRODUCT.md`, root integrated React prototype and static artifact routes/scenarios, Request semantics, and approved-design handoff rules
- `mockups/AGENTS.md`: canonical `mockups/src/**`, `pnpm build:mockup`, version-controlled output, and built-in Prototype Preview rules
