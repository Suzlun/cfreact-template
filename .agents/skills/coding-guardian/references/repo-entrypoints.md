...
- `openspec/config.yaml`: OpenDesign ownership of integrated React prototypes per public app and app-specific static artifact routes/scenarios, Request semantics, and approved-design handoff rules
