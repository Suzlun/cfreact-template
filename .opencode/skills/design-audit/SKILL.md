...
1. Design system: `packages/frontend/ui/src/styles/globals.css`, `packages/frontend/ui/src/components/ui/**`, `packages/frontend/ui/src/lib/utils.ts`, and `packages/frontend/ui/package.json`.
...
4. Tech stack: root `package.json`, `packages/frontend/app/package.json`, `packages/frontend/domain/package.json`, and `packages/frontend/ui/package.json`.
...
- Prefer existing `packages/frontend/ui` components and tokens.
