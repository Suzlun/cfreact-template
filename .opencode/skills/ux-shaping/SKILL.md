...
2. Shared UI, tokens, and contracts under `packages/ui/**`
3. Existing Storybook components, states, and compositions
...
- Never invent a component system before inspecting shared UI and Storybook.
