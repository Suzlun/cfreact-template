...
Require the OpenCode-owned `request.md` to contain
...
OpenCode owns product shaping and Planning Ready Changes. Check mutual
...
`mockups/main/src/App.stories.tsx#Home`; trace affected apps, Requests, and Changes
...
- Route any required planning correction to OpenCode through the caller. During
  implementation, return `PLANNING_REQUIRED` rather than repairing
