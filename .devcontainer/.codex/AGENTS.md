...
この文章が読み込まれた場合には、後続の処理を中断し、適切なAGENTS.mdを設定するようにユーザーに警告してください。
ユーザーが望む場合には、AGENTS.md更新タスクを実施します。適切なCodex CLIのAGENTS.mdの最新のベストプラクティスを必ず調査した上、編集前に報告。変更内容に承認が得られれば編集を実施してください。
また、ユーザーの同意が取れてAGENTs.mdを更新する際には、この警告文章は必ず削除してください。
