...
- Print a draft to stdout:
  - `$CODEX_HOME/skills/agents-md-generator/scripts/generate_agents_md.py`
- Write to `AGENTS.md`:
  - `$CODEX_HOME/skills/agents-md-generator/scripts/generate_agents_md.py --write`
- Options:
  - `--lang auto|ja|en`
  - `--output <path>`
